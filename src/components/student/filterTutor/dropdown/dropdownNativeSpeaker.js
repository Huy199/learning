  ...
  return (
    <div ref={wrapperRef}>
      <div className={isActiveView ? 'subFilter__selection-active' : 'subFilter__selection'}>
        ...
        >
          <span className='selection__core-title'>Người bản địa</span>
      ...
      {isActiveView && (
        <div className='subFilter__dropdown'>
          <div className='subFilter__dropdown-container'>
            ...
            <label className='subFilter__item'>
              <span className='subFilter__description'>Chỉ những người bản ngữ </span>
            </label>
          </div>
        </div>
      )}
...
export default DropdownNativeSpeaker;
